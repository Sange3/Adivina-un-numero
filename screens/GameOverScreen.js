    ...
    return ( 
        <View style={styles.screen}>
            ...
            <View style={styles.imageContainer}>
                <Image
                    source={require('../assets/success.png')} //imagenes locales
                    //source={{ uri: 'https://cdn.pixabay.com/photo/2016/05/05/23/52/mountain-summit-1375015_960_720.jpg' }} // imagenes de la web 
                    style={styles.image} 
                    reziseMode="cover" />
            </View>
